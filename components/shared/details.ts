...
export const workExperiences = [
  {
    ...
    description: "Contributing to the HotHealth platform — a Digital Front Door and Patient Portal for healthcare organisations — by designing scalable, high-performance solutions. Translated complex business requirements into robust features, integrated third-party systems, and collaborated across teams to support diverse healthcare workflows.",
    archivements: [
